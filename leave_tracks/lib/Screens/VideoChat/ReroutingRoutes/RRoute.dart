...
class Rroute extends StatefulWidget {
  final String tripName;
  final String routeId; // Add this line

  const Rroute({
    super.key,
    required this.tripName,
    required this.routeId, // Add this line
  });

  @override
  _RrouteState createState() => _RrouteState();
}

class _RrouteState extends State<Rroute> {
...
//  for the capturing and the storing of the information
  ...
  Future<void> _saveTrip() async {
    ...
    try {
      ...
      final url = Uri.parse('https://leave-tracks-backend.vercel.app/Reroutes');
      ...
      final payload = {
        ...
        'RouteId' : widget.routeId, // Add the ID to your payload
